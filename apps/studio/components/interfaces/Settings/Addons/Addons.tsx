            ...
            <ScaffoldSection>
              ...
              <ScaffoldSectionContent>
                <Alert_Shadcn_ variant="warning">
                  ...
                  <AlertDescription_Shadcn_>
                    IPv4 for direct connections or through db.projectref.supabase.co will resolve to
                    an IPv6 address starting from January 26th. If you plan on not using our
                    connection pooler and your environment does not support IPv4, consider enabling
                    the add-on.
                  </AlertDescription_Shadcn_>
                </Alert_Shadcn_>
                <div className="flex space-x-6">
