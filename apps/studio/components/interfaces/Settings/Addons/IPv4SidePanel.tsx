    ...
    >
      <SidePanel.Content>
        <div className="py-6 space-y-4">
          <p className="text-sm">
            By default direct connections to the database only work via IpV6. Enabling IPv4 allows
            you to directly connect to your database with IPv4. In case you are connecting using our
            Connection Pooler, you do not need this add-on as our connection pooler supports IPv4
            and IPv6. Enabling IPv4 is additive and IPv6 connections continue to work. You can check
            your connection info in your{' '}
